...
const BASE_URLS = {
    Library: 'https://biblioteca-abm.madeira.gov.pt',
    Archive: 'https://arquivo-abm.madeira.gov.pt',
    MainWebsite: 'https://drabl.madeira.gov.pt',
};
...
const quickAccessItems = [
    {
        initialText: 'Página',
        urlText: 'Biblioteca',
        url: `${BASE_URLS.Library}/`,
    },
    {
        initialText: 'Página',
        urlText: 'Arquivo',
        url: `${BASE_URLS.Archive}/`,
    },
    {
        initialText: 'Página',
        urlText: 'DRABL',
        url: `${BASE_URLS.MainWebsite}/`,
    },
    {
        initialText: 'Rede Biblioteca',
        urlText: 'PrismaWEB',
        url: `${BASE_URLS.Library}/Prismaweb/autenticar`,
    },
];
            ...
            >
                ...
                >
                    ...
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        Uma plataforma interna desenvolvida para prestar apoio eficiente e centralizado aos serviços da DRABL.
                    </p>
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        <li
                            class="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem]  before:border-[#e3e3e0] dark:before:border-[#3E3E3A]"
                            v-for="(item, index) in quickAccessItems" :key="index" :class="{ 'before:border-l': index !== quickAccessItems.length - 1 }"
                        >
                            <span
                ...
                >
                    <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        <path d="M15 32H35L48 78L61 32H81L94 78L107 32H127L108 102H85L71 52L57 102H34L15 32Z" fill="currentColor"/>

                        <path d="M140 32H158V102H140V32Z" fill="currentColor"/>

                        <path d="M175 82H192C192 88 197 90 205 90C212 90 218 87 218 82C218 77 213 75 200 72C182 68 170 62 170 48C170 36 182 28 205 28C228 28 238 38 239 52H222C221 45 216 42 205 42C195 42 188 45 188 50C188 54 193 56 205 58C222 62 236 67 236 82C236 96 224 104 205 104C184 104 174 95 175 82Z" fill="currentColor"/>

                        <path d="M255 32H273V102H255V32Z" fill="currentColor"/>
                    </svg>
                    <svg
                    ...
                    >
                        <g class="translate-y-0 opacity-100 transition-all delay-300 duration-750 starting:translate-y-4 starting:opacity-0">
                            ...
                            <path d="M100 250L220 50L340 250H100Z" stroke="#FF750F" stroke-width="0.5" opacity="0.3"/>
                            <path d="M50 300L220 100L390 300H50Z" stroke="#FF750F" stroke-width="1" opacity="0.5"/>
                            ...
                            <text
                                ...
                                text-anchor="middle"
                                fill="#FF750F"
                                style="font-family: ui-sans-serif, system-ui, sans-serif; font-weight: 900; font-size: 80px; letter-spacing: -0.05em;"
                            >
                                2.0
                            </text>

                            <path d="M0 350H440" stroke="#FF750F" stroke-width="1" stroke-dasharray="4 4"/>
                            <path d="M220 0V376" stroke="#FF750F" stroke-width="0.5" stroke-dasharray="2 2"/>
                        </g>
                    </svg>
                    <div
